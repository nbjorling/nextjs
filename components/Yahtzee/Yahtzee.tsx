...
const fields = [
  { id: "0", label: "Ones", icon: <Dice1Color key={1} />, value: 0, disabled: false },
  { id: "1", label: "Twos", icon: <Dice2Color key={1} />, value: 0, disabled: false },
  { id: "2", label: "Threes", icon: <Dice3Color key={1} />, value: 0, disabled: false },
  { id: "3", label: "Fours", icon: <Dice4Color key={1} />, value: 0, disabled: false },
  { id: "4", label: "Fives", icon: <Dice5Color key={1} />, value: 0, disabled: false },
  { id: "5", label: "Sixes", icon: <Dice6Color key={1} />, value: 0, disabled: false },
  { id: "6", label: "Summary", value: 0, disabled: true },
  { id: "7", label: "Bonus", value: 0, disabled: true },
  { id: "8", label: "One Pair", icon: [<Dice1Color key={1} />, <Dice1Color key={2} />], value: 0, disabled: false },
  {
    id: "9",
    label: "Two Pairs",
    icon: [<Dice2Color key={1} />, <Dice2Color key={2} />, <Dice3Color key={3} />, <Dice3Color key={4} />],
    value: 0,
    disabled: false,
  },
  {
    ...
    icon: [<Dice4Color key={1} />, <Dice4Color key={2} />, <Dice4Color key={3} />],
    value: 0,
    disabled: false,
  },
  {
    ...
    icon: [<Dice5Color key={1} />, <Dice5Color key={2} />, <Dice5Color key={3} />, <Dice5Color key={4} />],
    value: 0,
    disabled: false,
  },
  {
